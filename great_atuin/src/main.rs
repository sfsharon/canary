...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Default to eth2 if no interface is specified
    let interface_name = if args.len() > 1 {
        args[1].clone()
    }
     else {
        return Err("Add interface name".into())
    //     "eth2".to_string()
    };
    ...
    // DHCP discovery frame as hex string
    let hex_frame = "";
    ...
    // Send the frame
    println!("Sending DHCP discovery frame on {}...", interface_name);
    cap.sendpacket(frame_bytes)?;
    println!("DHCP discovery frame sent successfully");
