/*
    * General 
      ------------
    Send arbitrary binary stream to a socket
    ...
    * Usage
      ------------
    ./program <interface> <hex_string>

    For Example : 
    DHCP Discovery - 
    ./frame_sender eth2 ""

    DHCP Offer -
    ./frame_sender eth2 ""

    DHCP Request - 
    ./frame_sender eth2 ""

    DHCP Ack -
    ./frame_sender eth2 ""


    DUT 3021 x-eth 0/2/0 <-> eth2 - Regular DHCP interface
                                    Connected to ONL interface eth2

    DUT 3021 x-eth 0/2/1 <-> eth1 - Trusted DHCP interface
                                    Connected to ONL interface eth1
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if args.len() < 3 {
        eprintln!("Usage: {} <interface> <hex_string>", args[0]);
        process::exit(1);
    }
    ...
    let hex_frame = &args[2];
    
    // Get the specified network interface
    let device = match find_device(interface_name) {
        Some(dev) => dev,
        None => {
            eprintln!("Error: Interface {} not found", interface_name);
            process::exit(1);
        }
    };
